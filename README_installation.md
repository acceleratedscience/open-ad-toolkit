...
#### Notes
1. For a **simplified installation** without virtual environment, see [Quick Install](/README.md#quick-install)
...
4. If you prefer **Poetry**, you can run the poetry setup wizard instead: `poetry add openad`
