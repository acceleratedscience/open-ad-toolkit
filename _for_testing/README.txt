...
step 6: Run through each of the sample notebooks that hang off ~/openad_notebooks/Table_of_Contents.ipynb


Check for errors and Control character display issues