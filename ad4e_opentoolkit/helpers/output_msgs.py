...
messages = {
    ...
    'workspace_description': lambda workspace_name, description: (
        f'<yellow>{workspace_name}</yellow> <soft>(Workspace)</soft>',
        description
    ),
    ...
    # Error
    'fail_run_display': lambda run_name: (f'No run named "{run_name}" found.', 'To see available runs, run <cmd>list runs</cmd>.'),
    ...
    'toolkit_already_installed': lambda toolkit_name: (
        f'<soft>The <yellow>{toolkit_name}</yellow> toolkit was already installed.',
        f'Run <cmd>set context {toolkit_name}</cmd> to activate it.</soft>'  # Repeat B2
    ),
    ...
    'success_toolkit_install': lambda toolkit_name: (
        ...
        f'Run <cmd>set context {toolkit_name}</cmd> to activate it.'  # Repeat B3
    ),
    ...
    'invalid_toolkit': lambda toolkit_name: (f'There is no toolkit named <yellow>{toolkit_name}</yellow> available.', 'Please check your spelling.'),
    ...
    'err_toolkit_install': lambda toolkit_name, err: (f'There was an error installing the <yellow>{toolkit_name}</yellow> toolkit.', err),
