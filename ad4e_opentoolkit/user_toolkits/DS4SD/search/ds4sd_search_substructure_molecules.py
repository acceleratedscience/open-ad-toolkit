...
def search_substructure_molecules(inputs: dict,cmd_pointer):
    ...
    try:
        ...
        query = MoleculeQuery( query=inputs['smiles'],query_type=MolQueryType.SUBSTRUCTURE,)
    ...
    output_text(" <h2>  Search Results for smiles containing substructures of : </h2> ",cmd_pointer=cmd_pointer, return_val=False )
