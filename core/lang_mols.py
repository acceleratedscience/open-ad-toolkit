...
from helpers.general import parse_path_tree, confirm_prompt
...
def display_mols(cmd_pointer, parser):
    ...
    if cmd_pointer.notebook_mode:
        ...
        output_text(msg('m2g_launch'), cmd_pointer, pad_top=1)
        ...
        # loader(text, ',.-*°*-.', exit_msg=exit_msg, no_format=True, on_abort=kill_server)
...
# def smiles_to_iupac_old(smiles):
#     import requests
#     import pubchempy
