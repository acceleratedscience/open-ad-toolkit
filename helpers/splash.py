...
from .output import msg, output_text, output_error
from .style_parser import style, wrap_text, parse_tags, strip_tags, print_s
...
def splash(toolkit_name=None, cmd_pointer=None, startup=False, raw=False):
    ...
    if main_splash:
        json_file_path = f'metadata.json'
    else:
    ...
    try:
        ...
        return output_error(msg('fail_file_not_found', json_file_path, split=True))
