...
if (mi < 0) mi = (noAtoms && this.vwr.am.cmi < 0 ? 0 : noAtoms ? this.vwr.am.cmi : this.vwr.ms.at[bsAtoms.nextSetBit (0)].getModelIndex ());
...
var basis;
var sg = null;
var sgInfo = (noAtoms && !isDefined || isP1 ? null : this.vwr.findSpaceGroup (isDefined ? null : bsAtoms, isDefined ? (isITA ? "ITA/" + name : name) : null, sym.getUnitCellParams (), false, true));
if (sgInfo == null) {
name = "P1";
