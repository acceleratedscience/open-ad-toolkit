...
Clazz.load (["J.api.SymmetryInterface"], "JS.Symmetry", ["java.lang.ArrayIndexOutOfBoundsException", "$.IllegalArgumentException", "JU.BS", "$.JSJSONParser", "$.Lst", "$.M4", "$.P3", "$.PT", "$.Rdr", "J.api.Interface", "J.bspt.Bspt", "JS.PointGroup", "$.SpaceGroup", "$.SymmetryInfo", "$.SymmetryOperation", "$.UnitCell", "JU.Escape", "$.Logger", "$.SimpleUnitCell", "JV.FileManager"], function () {
