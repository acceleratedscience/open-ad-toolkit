...
Clazz_load (["J.api.SymmetryInterface"], "JS.Symmetry", ["java.lang.ArrayIndexOutOfBoundsException", "$.IllegalArgumentException", "JU.BS", "$.JSJSONParser", "$.Lst", "$.M4", "$.P3", "$.PT", "$.Rdr", "J.api.Interface", "J.bspt.Bspt", "JS.PointGroup", "$.SpaceGroup", "$.SymmetryInfo", "$.SymmetryOperation", "$.UnitCell", "JU.Escape", "$.Logger", "$.SimpleUnitCell", "JV.FileManager"], function () {
c$ = Clazz_decorateAsClass (function () {
...
if (itno == 0) {
return this.getResource (vwr, "sg/json/ita_all.json");
...
}this.opPoint.setT (JS.SymmetryOperation.opClean6 (p1sum));
if (angle != 180) {
p2.cross (px, p2);
this.opIsCCW = Boolean.$valueOf (p2.dot (v) < 0);
...
d = JS.SymmetryOperation.approx6 (this.opPoint.length ());
this.opTrans = JU.V3.newV (p1);
this.rotTrans (this.opTrans);
this.opTrans.scale (0.5);
d = JS.SymmetryOperation.approx6 (this.opTrans.length ());
this.opAxis = JU.V3.newVsub (p2, px);
if (d > 0) {
this.opAxis.sub (this.opTrans);
this.normalizeOpTrans (this.opTrans);
}this.opAxis.normalize ();
JS.SymmetryOperation.approx6Pt (this.opAxis);
this.opPlane =  new JU.P4 ();
isOK = JS.SymmetryOperation.checkOpPlane (this.opPoint, this.opAxis, this.opPlane);
JS.SymmetryOperation.normalizePlane (this.opPlane);
this.opAxis.setT (this.opPlane);
if (d > 0 && this.opTrans.z == 0 && this.opTrans.lengthSquared () == 1.25) {
dmax = 1.25;
this.opIsLong = true;
} else {
...
Clazz_defineMethod (c$, "normalizeOpTrans", 
 function (t) {
if (true) return;
if (t.x <= -0.5) {
t.x += 1;
...
}, "java.util.HashSet,JU.Lst,java.util.Map,~N,~N");
...
this.isFinalized = true;
if (itno == 11 && t.x == 1 && t.y == 0 && t.z == 0) System.out.println ("SO test" + opThis);
this.setOpTypeAndOrder ();
...
}, "JS.SymmetryOperation,JU.V3,~N,JU.V3,java.util.HashSet,JU.Lst,~N");
...
if (fx != 0 && fy != 0 && fz != 0) {
return ((fx == 0.25 || fx == 0.75) && (fy == 0.25 || fy == 0.75) && (fz == 0.25 || fz == 0.75) ? 'd' : fx == 0.5 && fy == 0.5 && fz == 0.5 ? 'n' : 'g');
}if (fx != 0 && fy != 0 || fy != 0 && fz != 0 || fz != 0 && fx != 0) {
if (fx == 0.25 && fy == 0.25 || fx == 0.25 && fz == 0.25 || fy == 0.25 && fz == 0.25) {
return 'd';
}if (fx == 0.5 && fy == 0.5 || fx == 0.5 && fz == 0.5 || fy == 0.5 && fz == 0.5) {
