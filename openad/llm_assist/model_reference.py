...
Answer the question based only on the following context: {context}  Question: {question} """,
        "settings": {"temperature": 0.5, "decoding_method": "greedy", "max_new_tokens": 3000, "min_new_tokens": 1},
        "embeddings": None,
        "embeddings_api": None,
    },
    "OLLAMA-granite": {
...
Answer:""",
        "settings": {"temperature": 0.5, "decoding_method": "greedy", "max_new_tokens": 5000, "min_new_tokens": 1},
        "embeddings": None,
        "embeddings_api": None,
    },
    "OPENAI": {
