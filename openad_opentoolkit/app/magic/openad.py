...
import openad_opentoolkit.app.main  # we import entire main library to help retain state
...
class AD(Magics):
    ...
    def openad(self, line, cell=None, local_ns=None):
        ...
        return openad_opentoolkit.app.main.api_remote(line, context_cache, api_variable)
